...
Table._template = () => /*html*/ `
        <div class="flex gap-4 justify-between">
            ...
            <div class="w-max flex flex-wrap gap-4 items-stretch">
                <div class="w-20 relative">
                    ...
                    <svg class="block w-4 h-4 text-gray-50 pointer-events-none absolute left-3 top-1/2 -translate-y-1/2" fill="currentcolor" viewBox="0 96 960 960">
        ...
        <div class="w-full rounded-md lg:rounded-xl my-4 overflow-hidden">
            <div data-container class="overflow-auto max-h-[800px] hover-scrollbar rounded-md lg:rounded-xl border border-gray-800">
                <table class="w-max min-w-full text-md text-gray-50">
                    <thead class="uppercase text-xs font-black sticky top-0 border-b border-gray-800" style="color: ${Table._style.text};background: ${Table._style.header};"></thead>
                    <tbody></tbody>
                </table>
            </div>
        </div>
