    ...
    <div class="w-full bg-gray-950 p-4 rounded-lg lg:rounded-2xl">
        <form action="{{ route('actions.profile.password') }}" method="POST" class="w-full flex flex-col gap-4">
            ...
            <div class="w-full flex flex-col gap-2">
                <label for="oldPassword" class="text-gray-50 text-md font-black">الرمز السري القديم</label>
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="w-full flex flex-col gap-2">
                    <label for="newPassword" class="text-gray-50 text-md font-black">الرمز السري الجديد</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for=confirmPassword" class="text-gray-50 text-md font-black">تأكيد الرمز السري</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
