        ...
        <form action="{{ route('actions.users.create') }}" method="POST" class="w-full flex flex-col gap-4">
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="w-full flex flex-col gap-2">
                    <label for="firstName" class="text-gray-50 text-md font-black">الاسم</label>
                    <div class="relative">
                        <input
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="lastName" class="text-gray-50 text-md font-black">النسب</label>
                    <div class="relative">
                        <input
                            class="appearance-none bg-[#4c4643] text-gray-50 h-[48px] text-lg rounded-md lg:rounded-xl block w-full py-2 px-4"
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-4">
                <div class="w-full flex flex-col gap-2">
                    <label for="identity" class="text-gray-50 text-md font-black">الهوية</label>
                    <div class="relative">
                        <input
                            class="appearance-none bg-[#4c4643] text-gray-50 h-[48px] text-lg rounded-md lg:rounded-xl block w-full py-2 px-4"
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="gender" class="text-gray-50 text-md font-black">الجنس</label>
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="birthDate" class="text-gray-50 text-md font-black">تاريخ الميلاد</label>
                    <div class="relative bg-[#4c4643] text-gray-50 rounded-md lg:rounded-xl">
                        <input x-date
                            class="appearance-none bg-[#4c4643] text-gray-50 h-[48px] text-lg rounded-md lg:rounded-xl block w-full py-2 px-4"
