        ...
        <form action="{{ route('actions.settings.update') }}" method="POST" class="w-full flex flex-col gap-4">
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="w-full flex flex-col gap-2">
                    <label for="facebook" class="text-gray-50 text-md font-black">فيسبوك</label>
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="instagram" class="text-gray-50 text-md font-black">إنستجرام</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="w-full flex flex-col gap-2">
                    <label for="twitter" class="text-gray-50 text-md font-black">تويتر</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="tiktok" class="text-gray-50 text-md font-black">تيك توك</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-4">
                <div class="w-full flex flex-col gap-2">
                    <label for="icecream" class="text-gray-50 text-md font-black">ايس كريم</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="kayak" class="text-gray-50 text-md font-black">كاياك</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
                ...
                <div class="w-full flex flex-col gap-2">
                    <label for="assurance" class="text-gray-50 text-md font-black">تأمين</label>
                    <div class="rounded-lg lg:rounded-2xl bg-[#4c4643] text-gray-50">
            ...
            <div class="w-full"></div>
            <div class="w-full flex flex-col gap-2">
                <label for="terms" class="text-gray-50 text-md font-black">الشروط والأحكام</label>
